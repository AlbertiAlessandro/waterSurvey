...
INSERT INTO `survey` VALUES (2,'Personal Water Consumption Habits','This survey aims to gather information about your daily water usage habits. Your responses will help us understand how individuals use water and identify areas where water conservation efforts can be improved. Please answer the following questions based on your typical daily routine.',1,0),(3,'Water Conservation Knowledge and Practices','This survey aims to assess your knowledge and practices regarding water conservation. Your responses will help identify areas where more education or resources might be needed to promote efficient water use. Your answers are anonymous and will only be use for the research',1,0);
...
INSERT INTO `user` VALUES (1,'ciao','ciao','albe@gmail.com','ciao',1,'ciao',NULL),(2,'telly','$2y$10$xEjq47Lm.EQpNavmQExzzeMQ859gI/lX..4FnbkylqTKcyHsk0BYO','nicolasmantelli05@gmail.com','prova',2,'prova',NULL),(4,'albe','$2y$10$D7HVO3E92Br74I5C6pQa7u5v.T82bK6DPiUDBjZlj7v.GL6gqQggS','alexalberti2005@gmail.com','Alessandro',2,'Alberti',NULL),(11,'admin','$2y$10$xRMQ4tp.wHwypKcdAEbTrebzYFKv8Vitgo/NcQDVCYUU9G5dMP7Sy','alebugo@gmail.com','Alessandro',1,'Bugatti',NULL),(12,'ronaldo','$2y$10$/v2VGLA2gC3LO4Y8.iDzK.wp7GDy8QKC4FJWLEtVopJoj/vu2Lpku','cr7@gmail.com','Cristiano',2,'Ronaldo',NULL);
...
-- Dump completed on 2024-05-24  9:23:24
